...
const json_dati = '[{"tokenAddress": "0xe9e7cea3dedca5984780bafc599bd69add087d56","decimals" : 18,"reward" : 0.006,"utcTime": "1 Jan 2022 00:00:00 UTC","apiKey": "CQMXE3Z94YNSY2HMF6IJVTVWMW5Z9DCH9A"}]';
const firePitAddress = '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c';
const wbnbAddress = '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c';
const liquidityAddress = '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c';
const treasuryAddress = '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c';
const insuranceAddress = '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c';
...
async function getMarketCap() {    
    const tokenPrice = await fetch("https://api.pancakeswap.info/api/v2/tokens/0xe9e7cea3dedca5984780bafc599bd69add087d56");
    const priceJson = await tokenPrice.json();
    price = priceJson.data.price;

    document.getElementById("price").innerHTML = "$" + Number(priceJson.data.price).toFixed(5);
    document.getElementById("price2").innerHTML = "$" + Number(priceJson.data.price).toFixed(5);
    document.getElementById("price3").innerHTML = "$" + Number(priceJson.data.price).toFixed(5);
    document.getElementById("input_price").value = Number(priceJson.data.price).toFixed(5);
    Promise.all([
        fetch('https://api.bscscan.com/api?module=stats&action=tokensupply&contractaddress=0xe9e7cea3dedca5984780bafc599bd69add087d56&apikey=FTIWQXC91GMC8ZIR9XNJCJS62CX62BBE7P'),
        fetch('https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xe9e7cea3dedca5984780bafc599bd69add087d56&address=0x4D69f806EA93222474cd82750BCcCB5ecBcb5A7b&tag=latest&apikey=CQMXE3Z94YNSY2HMF6IJVTVWMW5Z9DCH9A'),
        fetch('https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56=latest&apikey=FTIWQXC91GMC8ZIR9XNJCJS62CX62BBE7P'),
        fetch('https://api.pancakeswap.info/api/v2/tokens/0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56'),
        fetch('https://api.bscscan.com/api?module=account&action=balancemulti&address=0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56,0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56&tag=latest&apikey=FTIWQXC91GMC8ZIR9XNJCJS62CX62BBE7P'),
        fetch('https://busdstaking.com/js/data/busdTreasury.json'),
        fetch('https://busdstaking.com/js/data/busdInsurance.json'),
        fetch('https://busdstaking.com/js/data/unicrypt.json')
        ...
        document.getElementById("pool").innerHTML = "Working";
...
async function getBalance() {
    ...
    const format = result / Math.pow(1000000000000000000, 1);
    tokens = format;
    ...
    document.getElementById("roi_5_reward").innerHTML = (Number(format) * 17.6632).toFixed(4);
